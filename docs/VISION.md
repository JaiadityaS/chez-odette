...
**Odette.** She wakes at 4 a.m. Her grandmother's sourdough starter is older than the building. When you walk into her bakehouse, the smell hits you before the door closes. That smell is not information — it cannot be scraped — and it is the entire point.

Odette is being crushed by a real, documented machine:
...
- The agent era was about to erase even her thumbnail: a customer's agent, told "order good sourdough," goes to the aggregator, sorts by price/stars, and buys in 4ms without a human eye ever landing on Odette.
...
A customer's agent is told *"order me good sourdough for Saturday."* Instead of hitting a marketplace, it lands on **Odette's own site**, hears Odette's voice recommend the walnut levain for the occasion, checks it's actually in stock, and places the order directly. **Odette keeps the margin. Odette keeps the customer.** The soul survived the agent.
