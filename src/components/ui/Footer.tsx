  ...
  return (
    <footer id="visit" className="bg-wood text-white">
      <div className="mx-auto max-w-6xl px-6 py-12 text-center">
        <div className="masthead text-xl tracking-[0.26em]">Chez Amélie</div>
        <p className="mt-3 text-sm text-white/80">
          Open Tuesday to Sunday, from 7am until the shelves are bare.
        </p>
        ...
        <p className="mt-5 font-display italic text-base text-white/90">
          Ordered by an agent? It still came straight to Amélie.
        </p>
